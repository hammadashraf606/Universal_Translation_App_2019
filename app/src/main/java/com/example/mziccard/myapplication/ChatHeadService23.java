...
public class ChatHeadService23 extends Service {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (inBounded) {
                            if (MyDialog.active) {
                                MyDialog.myDialog.finishAffinity();
                                System.exit(0);
                            }

                            stopService(new Intent(ChatHeadService23.this, ChatHeadService23.class));
                            inBounded = false;
                            System.exit(0);
                            break;
                        }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            Log.d(Utils.LogTag, "ChatHeadService23.onConfigurationChanged -> landscap");
            ...
            Log.d(Utils.LogTag, "ChatHeadService23.onConfigurationChanged -> portrait");
    ...
    private void moveToLeft(final int x_cord_now) {
        ...
        new CountDownTimer(500, 5) {
            ...
            public void onTick(long t) {
                ...
                {
                    Toasty.error(getApplicationContext(), "Sorry there is no internet connection", Toast.LENGTH_SHORT, true).show();
    ...
    private void chathead_longclick() {
        Log.d(Utils.LogTag, "Into ChatHeadService23.chathead_longclick() ");
    ...
    private void showMsg(String sMsg) {
        if (txtView != null && chatheadView != null) {
            Log.d(Utils.LogTag, "ChatHeadService23.showMsg -> sMsg=" + sMsg);
            txt1.setText(sMsg);
            myHandler.removeCallbacks(myRunnable);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        // TODO Auto-generated method stub
        Log.d(Utils.LogTag, "ChatHeadService23.onStartCommand() -> startId=" + startId);
    ...
    public IBinder onBind(Intent intent) {
        // TODO Auto-generated method stub
        Log.d(Utils.LogTag, "ChatHeadService23.onBind()");
        return null;
    }
